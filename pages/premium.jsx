                        ...
                        <div className="col-12 col-sm-8 d-flex align-items-center" style={{justifyContent: "space-between"}}>
                            <div>
                                <span style={{fontSize: ".75rem"}}>
                                    ...
                                    &nbsp;{">"}&nbsp;
                                    <a href="/premium" className="fw-bolder">
                    ...
                    <div className="row justify-content-center">
                        <div className="col-10">
                            <div className="mt-3 mb-3 d-block text-center">
                                <h1 className="fs-5">PREMIUM PRODUCTS</h1>
                            </div>
                        </div>
                    </div>
                </div>
...
export async function getServerSideProps() {
  const { data, error } = await supabase.from('products').select().eq('type', "premium").order('id', { ascending: false });
